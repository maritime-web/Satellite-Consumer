...
# download for Ghana
curl -o "AERONET_Koforidua_ANUC.latest.terra.250m.tif" "https://lance-modis.eosdis.nasa.gov/imagery/subsets/?subset=AERONET_Koforidua_ANUC.terra.250m.tif"
curl -o "AERONET_Koforidua_ANUC.latest.aqua.250m.tif" "https://lance-modis.eosdis.nasa.gov/imagery/subsets/?subset=AERONET_Koforidua_ANUC.aqua.250m.tif"
checkFileSizes
